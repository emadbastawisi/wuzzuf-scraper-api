...
Revision ID: b6a6bd2677e5
Revises: 
Create Date: 2023-09-03 17:52:40.220928
...
def upgrade() -> None:
    ...
    sa.Column('job_titels', sa.String(), nullable=True),
    ...
    sa.Column('profeciency', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='cascade'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id')
    )
